...
contract RICHDOGEPOORDOGE is BEP20, Ownable {
    ...
    uint256 public tokenLiquidityThreshold = 241_000 * 10**18;
    uint256 public maxBuyLimit = 2_410_000 * 10**18;
    uint256 public maxSellLimit = 2_410_000 * 10**18;
    uint256 public maxWalletLimit = 2_410_000 * 10**18;

    uint256 public genesis_block;
    uint256 private deadline = 3;
    uint256 private launchtax = 99;

    address public marketingWallet = 0x50e1854A4002892eB4Dc03DC0aaAefCd1a917f56;
    address public devWallet = 0xD2B88AB1210157ace772F99d6DD4CdaE5626B63F;
    address public opsWallet = 0x8703FB7D8aDa08d8927d3010DA2c7137F6F67d1E;
    ...
    Taxes public taxes = Taxes(5, 2, 4, 1);
    Taxes public sellTaxes = Taxes(5, 2, 4, 1);
    ...
    constructor() BEP20("Rich Doge Poor Doge", "R1CH") {
        _tokengeneration(msg.sender, 241000000 * 10**decimals());
    ...
    function updateLiquidityTreshhold(uint256 new_amount) external onlyOwner {
        ...
        require(new_amount <= 2_410_000, "Swap threshold amount should be lower or euqal to 1% of tokens");
    ...
    function updateMaxTxLimit(uint256 maxBuy, uint256 maxSell, uint256 maxWallet) external onlyOwner {
        require(maxBuy >= 241_000, "Cannot set max buy amount lower than 0.1%");
        require(maxSell >= 241_000, "Cannot set max sell amount lower than 0.1%");
        require(maxWallet >= 2_410_000, "Cannot set max wallet amount lower than 1%");
